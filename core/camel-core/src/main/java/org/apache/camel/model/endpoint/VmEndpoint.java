...
public class VmEndpoint {
    ...
    public static class VmCommon<T extends EndpointConfiguration>
            extends
    ...
    public static class VmConsumer extends VmCommon<VmConsumer> {
    ...
    public static class VmProducer extends VmCommon<VmProducer> {
