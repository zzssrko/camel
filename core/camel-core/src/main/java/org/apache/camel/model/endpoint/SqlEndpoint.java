...
public class SqlEndpoint {
    ...
    public static class SqlConsumer
            extends
                SqlCommon<SqlConsumer>
            implements
                EndpointDefinition.Consumer {
        public SqlConsumer(String path) {
            super(path);
        }
        /**
    ...
    public static class SqlProducer
            extends
                SqlCommon<SqlProducer>
            implements
                EndpointDefinition.Producer {
        public SqlProducer(String path) {
            super(path);
        }
        /**
