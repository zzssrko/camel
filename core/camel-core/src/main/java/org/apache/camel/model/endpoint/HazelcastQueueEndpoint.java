...
public interface HazelcastQueueEndpoint {
    ...
    public static class HazelcastQueueCommon<T extends EndpointDefinition>
        ...
        HazelcastQueueCommon(String path) {
    ...
    public static class HazelcastQueueConsumer
            extends
                HazelcastQueueCommon<HazelcastQueueConsumer>
            implements
                EndpointDefinition.Consumer {
        public HazelcastQueueConsumer(String path) {
            super(path);
        }
        /**
         ...
         */
        public HazelcastQueueConsumer bridgeErrorHandler(
                boolean bridgeErrorHandler) {
            this.properties.put("bridgeErrorHandler", bridgeErrorHandler);
            return (HazelcastQueueConsumer) this;
        }
        /**
         * Define the polling timeout of the Queue consumer in Poll mode. The
         * option is a long type.
         */
        public HazelcastQueueConsumer pollingTimeout(long pollingTimeout) {
         ...
         * type.
         */
        public HazelcastQueueConsumer poolSize(int poolSize) {
         ...
         * type.
         */
        public HazelcastQueueConsumer queueConsumerMode(
         ...
         */
        public HazelcastQueueConsumer exceptionHandler(
         ...
         */
        public HazelcastQueueConsumer exchangePattern(
    ...
    public static class HazelcastQueueProducer
            extends
                HazelcastQueueCommon<HazelcastQueueProducer>
            implements
                EndpointDefinition.Producer {
        public HazelcastQueueProducer(String path) {
            super(path);
        }
    }
