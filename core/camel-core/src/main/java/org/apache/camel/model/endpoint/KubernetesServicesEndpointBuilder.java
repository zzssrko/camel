...
public interface KubernetesServicesEndpointBuilder {
    ...
    public static class KubernetesServicesCommonBuilder<T extends AbstractEndpointBuilder>
        ...
        KubernetesServicesCommonBuilder(String path) {
    ...
    public static class KubernetesServicesConsumerBuilder
        ...
        public KubernetesServicesConsumerBuilder(String path) {
            super(path);
        }
        /**
         ...
         */
        public KubernetesServicesConsumerBuilder bridgeErrorHandler(
                boolean bridgeErrorHandler) {
            this.properties.put("bridgeErrorHandler", bridgeErrorHandler);
            return (KubernetesServicesConsumerBuilder) this;
        }
        /**
         * Allows for bridging the consumer to the Camel routing Error Handler,
         * which mean any exceptions occurred while the consumer is trying to
         ...
         */
        public KubernetesServicesConsumerBuilder labelKey(String labelKey) {
         ...
         */
        public KubernetesServicesConsumerBuilder labelValue(String labelValue) {
         ...
         */
        public KubernetesServicesConsumerBuilder namespace(String namespace) {
         ...
         */
        public KubernetesServicesConsumerBuilder poolSize(int poolSize) {
         ...
         * <code>int</code> type.
         */
        public KubernetesServicesConsumerBuilder poolSize(String poolSize) {
            this.properties.put("poolSize", poolSize);
            return (KubernetesServicesConsumerBuilder) this;
        }
        /**
         ...
         * <code>java.lang.String</code> type.
         */
        public KubernetesServicesConsumerBuilder resourceName(
                String resourceName) {
         ...
         */
        public KubernetesServicesConsumerBuilder exceptionHandler(
         ...
         */
        public KubernetesServicesConsumerBuilder exchangePattern(
    ...
    public static class KubernetesServicesProducerBuilder
        ...
        public KubernetesServicesProducerBuilder(String path) {
            super(path);
        }
        /**
         ...
         * <code>java.lang.String</code> type.
         */
        public KubernetesServicesProducerBuilder operation(String operation) {
