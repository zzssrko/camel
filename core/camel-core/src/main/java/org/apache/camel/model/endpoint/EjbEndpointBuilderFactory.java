...
public interface EjbEndpointBuilderFactory {
    ...
    public static interface AdvancedEjbEndpointBuilder
         ...
         * @group advanced
         */
        public default AdvancedEjbEndpointBuilder cache(Boolean cache) {
         ...
         * @group advanced
         */
        public default AdvancedEjbEndpointBuilder cache(String cache) {
            setProperty("cache", cache);
            return this;
        }
        /**
         ...
         * @group advanced
         */
        public default AdvancedEjbEndpointBuilder parameters(
         ...
         * @group advanced
         */
        public default AdvancedEjbEndpointBuilder parameters(String parameters) {
            setProperty("parameters", parameters);
            return this;
        }
        /**
