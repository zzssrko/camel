...
public class DataSetEndpoint {
    ...
    public static class DataSetCommon extends EndpointConfiguration {
        /**
    ...
    public static class DataSetConsumer extends DataSetCommon {
        /**
    ...
    public static class DataSetProducer extends DataSetCommon {
        /**
         * Allows a delay to be specified which causes a delay when a message is
