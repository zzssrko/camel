...
public interface GuavaEventBusEndpointBuilder {
    ...
    public static class GuavaEventBusCommonBuilder<T extends AbstractEndpointBuilder>
        ...
        GuavaEventBusCommonBuilder(String path) {
    ...
    public static class GuavaEventBusConsumerBuilder
        ...
        public GuavaEventBusConsumerBuilder(String path) {
            super(path);
        }
        /**
        ...
        public GuavaEventBusConsumerBuilder bridgeErrorHandler(
            ...
            return (GuavaEventBusConsumerBuilder) this;
        }
        /**
         * Allows for bridging the consumer to the Camel routing Error Handler,
         * which mean any exceptions occurred while the consumer is trying to
    ...
    public static class GuavaEventBusProducerBuilder
        ...
        public GuavaEventBusProducerBuilder(String path) {
            super(path);
        }
    }
