...
public class EjbEndpoint {
    ...
    public static class EjbCommon extends EndpointConfiguration {
        /**
    ...
    public static class EjbConsumer extends EjbCommon {
    }

    public static class EjbProducer extends EjbCommon {
    }
}