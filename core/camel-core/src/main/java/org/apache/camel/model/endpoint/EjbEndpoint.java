...
public class EjbEndpoint {
    ...
    public static class EjbCommon<T extends EndpointConfiguration>
            extends
    ...
    public static class EjbConsumer extends EjbCommon<EjbConsumer> {
    }

    public static class EjbProducer extends EjbCommon<EjbProducer> {
    }
}