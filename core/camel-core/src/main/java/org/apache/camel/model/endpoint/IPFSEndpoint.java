...
public class IPFSEndpoint {
    ...
    public static class IPFSCommon extends EndpointConfiguration {
        /**
    ...
    public static class IPFSConsumer extends IPFSCommon {
    }

    public static class IPFSProducer extends IPFSCommon {
    }
}