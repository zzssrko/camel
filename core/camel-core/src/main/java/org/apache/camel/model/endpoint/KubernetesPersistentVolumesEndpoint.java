...
public interface KubernetesPersistentVolumesEndpoint {
    ...
    public static class KubernetesPersistentVolumesCommon<T extends EndpointDefinition>
        ...
        KubernetesPersistentVolumesCommon(String path) {
    ...
    public static class KubernetesPersistentVolumesProducer
        ...
        public KubernetesPersistentVolumesProducer(String path) {
            super(path);
        }
        /**
         ...
         * java.lang.String type.
         */
        public KubernetesPersistentVolumesProducer operation(String operation) {
