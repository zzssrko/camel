...
public interface BeanEndpointBuilderFactory {
    ...
    public static interface AdvancedBeanEndpointBuilder
         ...
         * @group advanced
         */
        public default AdvancedBeanEndpointBuilder cache(Boolean cache) {
         ...
         * @group advanced
         */
        public default AdvancedBeanEndpointBuilder cache(String cache) {
            setProperty("cache", cache);
            return this;
        }
        /**
         ...
         * @group advanced
         */
        public default AdvancedBeanEndpointBuilder parameters(
         ...
         * @group advanced
         */
        public default AdvancedBeanEndpointBuilder parameters(String parameters) {
            setProperty("parameters", parameters);
            return this;
        }
        /**
