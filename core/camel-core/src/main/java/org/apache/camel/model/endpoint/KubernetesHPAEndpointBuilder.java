...
public interface KubernetesHPAEndpointBuilder {
    ...
    public static class KubernetesHPACommonBuilder<T extends AbstractEndpointBuilder>
        ...
        KubernetesHPACommonBuilder(String path) {
    ...
    public static class KubernetesHPAConsumerBuilder
        ...
        public KubernetesHPAConsumerBuilder(String path) {
            super(path);
        }
        /**
         ...
         */
        public KubernetesHPAConsumerBuilder labelKey(String labelKey) {
         ...
         */
        public KubernetesHPAConsumerBuilder labelValue(String labelValue) {
         ...
         */
        public KubernetesHPAConsumerBuilder namespace(String namespace) {
         ...
         */
        public KubernetesHPAConsumerBuilder poolSize(int poolSize) {
         ...
         * java.lang.String type.
         */
        public KubernetesHPAConsumerBuilder resourceName(String resourceName) {
    ...
    public static class KubernetesHPAProducerBuilder
        ...
        public KubernetesHPAProducerBuilder(String path) {
            super(path);
        }
        /**
         ...
         * java.lang.String type.
         */
        public KubernetesHPAProducerBuilder operation(String operation) {
