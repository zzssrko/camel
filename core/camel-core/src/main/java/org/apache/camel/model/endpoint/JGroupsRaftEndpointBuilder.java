...
public interface JGroupsRaftEndpointBuilder {
    ...
    public static class JGroupsRaftCommonBuilder<T extends AbstractEndpointBuilder>
        ...
        JGroupsRaftCommonBuilder(String path) {
    ...
    public static class JGroupsRaftConsumerBuilder
        ...
        public JGroupsRaftConsumerBuilder(String path) {
            super(path);
        }
        /**
         ...
         * If set to true, the consumer endpoint will receive roleChange event
         * as well (not just connecting and/or using the state machine). By
         * default it is set to false. The option will be converted to a boolean
         * type.
         */
        public JGroupsRaftConsumerBuilder enableRoleChangeEvents(
    ...
    public static class JGroupsRaftProducerBuilder
        ...
        public JGroupsRaftProducerBuilder(String path) {
            super(path);
        }
    }
