...
public class MsvEndpoint {
    ...
    public static class MsvCommon extends EndpointConfiguration {
        /**
    ...
    public static class MsvConsumer extends MsvCommon {
    }

    public static class MsvProducer extends MsvCommon {
    }
}