...
public interface KubernetesResourcesQuotaEndpoint {
    ...
    public static class KubernetesResourcesQuotaCommon<T extends EndpointDefinition>
        ...
        KubernetesResourcesQuotaCommon(String path) {
    ...
    public static class KubernetesResourcesQuotaProducer
        ...
        public KubernetesResourcesQuotaProducer(String path) {
            super(path);
        }
        /**
         ...
         * java.lang.String type.
         */
        public KubernetesResourcesQuotaProducer operation(String operation) {
