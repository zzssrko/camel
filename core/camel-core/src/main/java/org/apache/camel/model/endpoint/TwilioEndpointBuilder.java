...
public interface TwilioEndpointBuilder {
    ...
    /**
     * Base class for the Twilio component builders.
     */
     ...
     * using Twilio Java SDK. Creates a builder to build a consumer endpoint for
     * the Twilio component.
     */
    ...
    /**
     * The Twilio component allows you to interact with the Twilio REST APIs
     * using Twilio Java SDK. Creates a builder to build a producer endpoint for
     * the Twilio component.
     */
