...
public class CordaEndpoint {
    ...
    public static class CordaCommon<T extends EndpointConfiguration>
            extends
    ...
    public static class CordaConsumer extends CordaCommon<CordaConsumer> {
    ...
    public static class CordaProducer extends CordaCommon<CordaProducer> {
    }
}