...
public class SedaEndpoint {
    ...
    public static class SedaConsumer
            extends
                SedaCommon<SedaConsumer>
            implements
                EndpointDefinition.Consumer {
        public SedaConsumer(String path) {
            super(path);
        }
        /**
    ...
    public static class SedaProducer
            extends
                SedaCommon<SedaProducer>
            implements
                EndpointDefinition.Producer {
        public SedaProducer(String path) {
            super(path);
        }
        /**
