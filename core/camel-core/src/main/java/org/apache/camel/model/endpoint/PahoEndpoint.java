...
public class PahoEndpoint {
    ...
    public static class PahoConsumer
            extends
                PahoCommon<PahoConsumer>
            implements
                EndpointDefinition.Consumer {
        public PahoConsumer(String path) {
            super(path);
        }
        /**
    ...
    public static class PahoProducer
            extends
                PahoCommon<PahoProducer>
            implements
                EndpointDefinition.Producer {
        public PahoProducer(String path) {
            super(path);
        }
    }
