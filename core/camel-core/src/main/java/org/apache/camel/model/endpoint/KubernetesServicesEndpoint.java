...
public interface KubernetesServicesEndpoint {
    ...
    public static class KubernetesServicesCommon<T extends EndpointDefinition>
        ...
        KubernetesServicesCommon(String path) {
    ...
    public static class KubernetesServicesConsumer
            extends
                KubernetesServicesCommon<KubernetesServicesConsumer>
            implements
                EndpointDefinition.Consumer {
        public KubernetesServicesConsumer(String path) {
            super(path);
        }
        /**
         ...
         */
        public KubernetesServicesConsumer bridgeErrorHandler(
                boolean bridgeErrorHandler) {
            this.properties.put("bridgeErrorHandler", bridgeErrorHandler);
            return (KubernetesServicesConsumer) this;
        }
        /**
         * The Consumer Label key when watching at some resources. The option is
         * a java.lang.String type.
         */
        public KubernetesServicesConsumer labelKey(String labelKey) {
         ...
         */
        public KubernetesServicesConsumer labelValue(String labelValue) {
         ...
         */
        public KubernetesServicesConsumer namespace(String namespace) {
         ...
         */
        public KubernetesServicesConsumer poolSize(int poolSize) {
         ...
         * java.lang.String type.
         */
        public KubernetesServicesConsumer resourceName(String resourceName) {
         ...
         */
        public KubernetesServicesConsumer exceptionHandler(
         ...
         */
        public KubernetesServicesConsumer exchangePattern(
    ...
    public static class KubernetesServicesProducer
            extends
                KubernetesServicesCommon<KubernetesServicesProducer>
            implements
                EndpointDefinition.Producer {
        public KubernetesServicesProducer(String path) {
            super(path);
        }
        /**
         ...
         * java.lang.String type.
         */
        public KubernetesServicesProducer operation(String operation) {
