...
public class CinderEndpoint {
    ...
    public static class CinderCommon extends EndpointConfiguration {
        /**
    ...
    public static class CinderConsumer extends CinderCommon {
    }

    public static class CinderProducer extends CinderCommon {
    }
}