...
public class KubernetesPersistentVolumesClaimsEndpoint {
    ...
    public static class KubernetesPersistentVolumesClaimsCommon<T extends EndpointDefinition>
        ...
        KubernetesPersistentVolumesClaimsCommon(String path) {
    ...
    public static class KubernetesPersistentVolumesClaimsProducer
        ...
        public KubernetesPersistentVolumesClaimsProducer(String path) {
            super(path);
        }
        /**
         ...
         * java.lang.String type.
         */
        public KubernetesPersistentVolumesClaimsProducer operation(
                String operation) {
