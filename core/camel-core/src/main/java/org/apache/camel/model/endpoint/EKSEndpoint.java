...
public class EKSEndpoint {
    ...
    public static class EKSCommon extends EndpointConfiguration {
        /**
    ...
    public static class EKSConsumer extends EKSCommon {
    }

    public static class EKSProducer extends EKSCommon {
        /**
