...
public interface WsEndpointBuilder {
    ...
    public static class WsConsumerBuilder
        ...
        public WsConsumerBuilder(String path) {
            super(path);
        }
        /**
         * Whether to send an message if the web-socket listener received an
         * error. The option is a <code>boolean</code> type.
         */
        public WsConsumerBuilder sendMessageOnError(boolean sendMessageOnError) {
            this.properties.put("sendMessageOnError", sendMessageOnError);
            return (WsConsumerBuilder) this;
        }
        /**
         * Whether to send an message if the web-socket listener received an
         * error. The option will be converted to a <code>boolean</code> type.
         */
        public WsConsumerBuilder sendMessageOnError(String sendMessageOnError) {
            this.properties.put("sendMessageOnError", sendMessageOnError);
            return (WsConsumerBuilder) this;
        }
    }
    ...
    public static class WsProducerBuilder
        ...
        public WsProducerBuilder(String path) {
            super(path);
        }
        /**
         ...
         */
        public WsProducerBuilder useStreaming(boolean useStreaming) {
         ...
         */
        public WsProducerBuilder useStreaming(String useStreaming) {
            this.properties.put("useStreaming", useStreaming);
            return (WsProducerBuilder) this;
        }
        /**
         ...
         * <code>boolean</code> type.
         */
        public WsProducerBuilder connectionClose(boolean connectionClose) {
         ...
         * converted to a <code>boolean</code> type.
         */
        public WsProducerBuilder connectionClose(String connectionClose) {
            this.properties.put("connectionClose", connectionClose);
            return (WsProducerBuilder) this;
        }
        /**
         ...
         * type.
         */
        public WsProducerBuilder cookieHandler(Object cookieHandler) {
         ...
         */
        public WsProducerBuilder cookieHandler(String cookieHandler) {
            this.properties.put("cookieHandler", cookieHandler);
            return (WsProducerBuilder) this;
        }
    }
