...
public class GlanceEndpoint {
    ...
    public static class GlanceCommon<T extends EndpointConfiguration>
            extends
    ...
    public static class GlanceConsumer extends GlanceCommon<GlanceConsumer> {
    }

    public static class GlanceProducer extends GlanceCommon<GlanceProducer> {
    }
}