...
public class GlanceEndpoint {
    ...
    public static class GlanceCommon extends EndpointConfiguration {
        /**
    ...
    public static class GlanceConsumer extends GlanceCommon {
    }

    public static class GlanceProducer extends GlanceCommon {
    }
}