...
public interface OptaPlannerEndpointBuilder {
    ...
    public static class OptaPlannerCommonBuilder<T extends AbstractEndpointBuilder>
        ...
        OptaPlannerCommonBuilder(String path) {
    ...
    public static class OptaPlannerConsumerBuilder
        ...
        public OptaPlannerConsumerBuilder(String path) {
            super(path);
        }
        /**
        ...
        public OptaPlannerConsumerBuilder bridgeErrorHandler(
            ...
            return (OptaPlannerConsumerBuilder) this;
        }
        /**
         * Allows for bridging the consumer to the Camel routing Error Handler,
         * which mean any exceptions occurred while the consumer is trying to
    ...
    public static class OptaPlannerProducerBuilder
        ...
        public OptaPlannerProducerBuilder(String path) {
            super(path);
        }
        /**
