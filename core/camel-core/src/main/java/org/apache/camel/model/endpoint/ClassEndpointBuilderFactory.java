...
public interface ClassEndpointBuilderFactory {
    ...
    public static interface AdvancedClassEndpointBuilder
         ...
         * @group advanced
         */
        public default AdvancedClassEndpointBuilder cache(Boolean cache) {
         ...
         * @group advanced
         */
        public default AdvancedClassEndpointBuilder cache(String cache) {
            setProperty("cache", cache);
            return this;
        }
        /**
         ...
         * @group advanced
         */
        public default AdvancedClassEndpointBuilder parameters(
         ...
         * @group advanced
         */
        public default AdvancedClassEndpointBuilder parameters(String parameters) {
            setProperty("parameters", parameters);
            return this;
        }
        /**
