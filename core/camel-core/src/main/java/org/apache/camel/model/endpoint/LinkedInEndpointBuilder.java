...
public interface LinkedInEndpointBuilder {
    ...
    public static class LinkedInCommonBuilder<T extends AbstractEndpointBuilder>
        ...
        LinkedInCommonBuilder(String path) {
            super("linkedin", path);
        }
        /**
    ...
    public static class LinkedInConsumerBuilder
        ...
        public LinkedInConsumerBuilder(String path) {
            super(path);
        }
        /**
        ...
        public LinkedInConsumerBuilder bridgeErrorHandler(
            ...
            return (LinkedInConsumerBuilder) this;
        }
        /**
         * Allows for bridging the consumer to the Camel routing Error Handler,
         * which mean any exceptions occurred while the consumer is trying to
    ...
    public static class LinkedInProducerBuilder
        ...
        public LinkedInProducerBuilder(String path) {
            super(path);
        }
    }
