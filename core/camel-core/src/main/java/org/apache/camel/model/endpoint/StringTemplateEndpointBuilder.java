...
public interface StringTemplateEndpointBuilder {
    ...
    public static class StringTemplateCommonBuilder<T extends AbstractEndpointBuilder>
        ...
        StringTemplateCommonBuilder(String path) {
        ...
        /**
         * The variable start delimiter. The option will be converted to a char
         * type.
         */
        ...
        /**
         * The variable end delimiter. The option will be converted to a char
         * type.
         */
    ...
    public static class StringTemplateProducerBuilder
        ...
        public StringTemplateProducerBuilder(String path) {
            super(path);
        }
    }
